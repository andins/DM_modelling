...
b = 5;  % boundary
duration = 1000;  % ms
range_z = [ ];  % range for initial point distribution (uniform distr)
...
% NOTE: for this exercise set params.trialLen to 'free'
run('wong_params.m')  
